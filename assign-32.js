...
let current_users = ['Ayesha', 'Owais', 'Fahan', 'Tahir', 'Babar', 'Hafeez', 'Usman', 'Nafay', 'Bill Gates'];
...
let new_users = ['Furqan', 'Talha', 'Taha', 'Raza', 'BABAR', 'Hafeez', 'Khubabib', 'Umar', 'Abu Bakar'];
